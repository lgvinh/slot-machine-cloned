...
struct ContentView: View {
    ...
    @State private var alertTitle = "Please type your name here"
        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 5) {
                ...
                HStack {
                    ...
                    // Second HStack
                    HStack {
                        if globalVariables.leaderBoards.count > 0 {
                            Text("\(globalVariables.leaderBoards[0].score)")
                                // Adding reuzable code
                                .scoreNumberStyle()
                                .modifier(ScoreNumberModifier())
                        } else {
                    ...
                    VStack(spacing: 0) {
                        ...
                        , spacing: 16) {
                            ...
                            Text("Bad luck! You lost all of the coins. \nLet's play again!")
                                ...
                                .layoutPriority(1)
                            TextField("placeholder", text: $alertTitle).textFieldStyle(.roundedBorder).padding()

                            Button(action: {
                                self.globalVariables.addNewLeader(
                                    leader: Leader(name: alertTitle, score: highscore)
                                )
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        ContentView(global: GlobalVariables())
